        ...
        <MDBRow style={{paddingTop: '15%' , marginBottom: '5%'}}>
          ...
          <MDBCol sm='6'>
            <MDBCard className=" bg-light">
              <MDBCardBody>
                <MDBCardTitle className='text-dark text-center ' style={{fontSize: '28px'}}>EDIT TEACHER</MDBCardTitle>
                <div class="mb-3 mt-5">
                    <label  class="form-label">Teacher Name </label>
                    <input class="form-control" value={teacherName}  onChange={(e) =>{
                ...
                <div class="mb-3">
                  ...
                  <NumberFormat format="0## ### ####" value={teacherTel} class="form-control" placeholder="0** *** ****"  onChange={(e) =>{
                            setteacherTel(e.target.value);
                         }}/>
                </div> 
                <div class="mb-3">
                    <label  class="form-label">Email </label>
                    <input class="form-control" value={teacherEmail}  onChange={(e) =>{
                            setteacherEmail(e.target.value);
                         }}/>
                </div>
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label">Grade </label>
                  <select class="form-select" value={teacherGrade} onChange={(e) =>{
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" value={teacherCenter}  onChange={(e) =>{
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" value={teacherSubject} onChange={(e) =>{
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" value={classType} onChange={(e) =>{
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" value={classOrganization} onChange={(e) =>{
                ...
                <div className='text-end'>
                  ...
                  <MDBBtn href='#' color="success" className='shadow-0' onClick={editTeacher}  >Edit</MDBBtn>
                </div>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
